...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'views', name: 'system-views', component: () => import('../views/SystemViewsView.vue') },
      { path: 'project-notes', name: 'project-notes', component: () => import('../views/ProjectNotesView.vue') },
